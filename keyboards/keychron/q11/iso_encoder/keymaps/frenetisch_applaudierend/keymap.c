...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTZ_BASE] = LAYOUT_92_iso(
        ...
        _______,  KC_LCTL,  KC_LWIN,  KC_LALT,  MO(CLMK_FN),         KC_SPC,                        KC_SPC,             KC_RALT,  MO(CLMK_FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [QWERTZ_FN] = LAYOUT_92_iso(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [QWERTZ_BASE] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [QWERTZ_FN]   = { ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(RM_VALD, RM_VALU) },
    [CLMK_BASE] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [CLMK_FN]   = { ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(RM_VALD, RM_VALU) }
};
